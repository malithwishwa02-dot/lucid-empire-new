...
from lucid_browser.pkgman import LOCAL_DATA, GitHubDownloader, rprint, webdl
from lucid_browser.warnings import LeakWarning
...
def geoip_allowed() -> None:
    ...
    if not ALLOW_GEOIP:
        raise NotInstalledGeoIPExtra(
            'Please install the geoip extra to use this feature: pip install lucid_browser[geoip]'
        )
